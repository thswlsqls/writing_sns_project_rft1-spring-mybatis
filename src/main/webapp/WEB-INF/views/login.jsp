	...
	<div class="d-flex flex-column justify-content-center align-items-center viewContainer">
		<div class="d-flex flex-column justify-content-center align-items-center">
			<div class="d-flex flex-column justify-content-center align-items-center">
				...
				<h5 class="loginTitle">당신의 오늘은 어땠나요?</h5><br>
				<h1><b>Log-In</b></h1>
			</div>
			<div class="p-2 container mt-3 submitFormContainer">
			  <form action="${pageContext.request.contextPath}/loginAction" class="submitForm" method="post" onsubmit="rememberCheck(this)" name="frm">	<!-- **** -->
			    ...
			    <div class="d-flex form-check mb-3">
			      <label class="form-check-label ">
			        <input class="form-check-input loginCheck" type="checkbox" name="remember" id="remember"> 
			        	로그인 상태 유지
			      </label>
			    </div>
			    <button type="submit" class="btn btn-primary w-100 submitBtn korFontMain">로그인</button>
			  </form>
			</div>
			<div class="d-flex justify-content-around w-100" >
				<button type="button" class="btn linkBtn linkBtnCustom  " onclick="location.href='${pageContext.request.contextPath}/addUserUI'">회원가입</button>
				<button type="button" class="btn linkBtn" onclick="location.href='${pageContext.request.contextPath}/findUserUI'">ID/PW 찾기</button>
			</div>
		</div>
	</div>
</body>
...
<style type="text/css">
	...
	.viewContainer{
		...
		background-image: url("/project/resources/img/login.png");
	}
	.submitFormContainer{
		border-radius: 20px;
